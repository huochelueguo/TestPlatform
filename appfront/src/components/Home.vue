<template>
  <div class="home">
    <el-row display="margin-top:10px">
      <el-input v-model="input" placeholder="请输入书名!!" style="display:inline-table; width: 30%; float:left"/>
      <el-button type="primary" @click="addBook()" style="float:left; margin: 2px;">新增新增新增</el-button>
    </el-row>
    <el-row>
